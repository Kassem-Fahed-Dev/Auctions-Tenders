		...
		<>
			<div class="footer">
				...
				<div className="footer-list">
					...
					<Link to="/privacy" >
						<h1 className={`hov1 hov privacy ${ black==='privacy'?'bold1 ':''}`} onClick={()=>hoverItems1('privacy1')}>سياسة الخصوصية </h1>
					</Link>
					<Link to="/privacy1" >
						<h1 className={`hov1 hov ${black==='privacy1'?'bold1':' '}`} onClick={()=>hoverItems1('privacy2')}>الشروط والأحكام</h1>
					</Link>
				</div>
				<div className="copy">
