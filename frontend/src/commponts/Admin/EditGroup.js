...
export default function EditGroup() {
  ...
  let payload={}
    ...
    setHoverAuction("spinner-Auction");
      ...
      await axiosInstance.patch(`/api/v1/categories/${id}`, JSON.stringify(payload), {
              ...
              <div className="con_flextowside">
                ...
                <div >
                  ...
                  />
                    ...
                    <div className="leftsideGroup" style={{ backgroundImage: images.length!=0?`url(${images})`:`url(${formData1?.image})`,zIndex:'3', backgroundSize: 'cover', backgroundPosition: 'center', padding: '0px', color: 'white' }}>
                      <div className="buttom_side">
                        <p className="qustion1">{formData1?.name==''?'?':formData1?.name}</p>
                      </div>
                      <div className="circlediv" style={{backgroundColor:'transparent'}}>
                        
                        <p className="qustion" style={{color:'transparent'}}>?</p>
                      </div>
                    </div>
                    <div className="ptn_group2">
                      <button onClick={(e)=>{handleSubmit(e,group?._id)}}>حفظ</button>
                      <button
                        className="reject"
                        onClick={() => {
                          goBack();
                ...
                <div className="fixdisplay">
                  <div className="second_name_Admin">
                    ...
                    <input type="number" className="name_in" value={formData1?.properties.length} onChange={(e)=>{handleChange3(e)}}/>
                  </div>
               {rows}
                </div>
                </div>
