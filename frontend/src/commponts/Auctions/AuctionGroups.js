  ...
  return (
    <div>
      ...
      <div className='group-div div1'>
        <Link className='link' to='/car' >سيارات</Link>
      </div>
      <div className='group-div div2'>
      <Link className='link' to="/bilding">عقارات</Link>
      </div>
      <div className='group-div div3'>
      <Link className='link' to="/elctron">إلكترونيات</Link>
      </div>
      <div className='group-div div4'>
      <Link className='link' to="/fir">أثاث</Link>
      </div>
      <div className='group-div div5'>
      <Link className='link' to="/clothe">ملابس</Link>
      </div>
      <div className='group-div div6'>
      <Link className='link' to="/jel">إكسسوار</Link>
      </div>
      <div className='group-div div7'>
      <Link className='link' to="/other">أخرى</Link>
      </div>
      </div>
      <Footer/>
    </div>
